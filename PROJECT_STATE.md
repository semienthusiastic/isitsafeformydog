...
55 priority pages completed, in approximate chronological order:
...
**Anomaly tracking — zero-click-at-strong-position pages:** Eight data points now. /eggs/ (§4.1 entry 21, fully rewritten, no title/meta fix applied) remains the control case — still at 0 clicks as of the most recent full reading despite ~7,300 impressions at a strong position (~7.5-7.7). /apple/ (entry 46), /ricotta-cheese/ (entry 47), /coleslaw/ (entry 49), /capers/ (entry 51), /feta-cheese/ (entry 52), /brown-sugar/ (entry 54), and /swiss-cheese/ (entry 55) all shipped with deliberately CTR-optimised metaTitles/descriptions as test cases. /buttermilk/ (entry 50) and /artichoke/ (entry 53) remain deliberately excluded — buttermilk was already lightly converting, artichoke's historical click data is confounded by the URL-duplication bug fixed in §5.13.
