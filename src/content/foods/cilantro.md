...
description: "Veterinary pet-care sources state that cilantro is not toxic to dogs, but its strong flavour and plant compounds may cause digestive upset or aversion in some dogs."
source: ["AKC", "PetMD"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-cilantro/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-cilantro"]
keywords: ["cilantro", "can dogs eat cilantro", "dog safety", "cilantro dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Cilantro is generally considered non-toxic to dogs according to sources such as the AKC and PetMD, but veterinary references note that some dogs experience digestive upset or dislike its strong flavour. Concerns relate to tolerance rather than toxicity."]
---
...
- ❌ **Garlic or onion** (often paired with cilantro in dishes; classified as toxic to dogs)  
- ❌ **Salt or spices** (may increase digestive irritation)  
- ⚠️ **Sauces or dressings** containing cilantro (often include unsuitable ingredients)
