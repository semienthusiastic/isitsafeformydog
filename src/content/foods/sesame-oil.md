...
description: "Veterinary and pet-nutrition sources describe sesame and sesame-derived products as not toxic to dogs, while noting that oils are highly concentrated fats that may cause digestive upset or other issues if consumed."
source: ["AKC", "PetMD"]
sourceUrl: [
...
keywords: ["sesame oil", "can dogs eat sesame oil", "sesame dogs", "oils dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary nutrition sources such as the AKC and PetMD explain that sesame and sesame-based products are not poisonous to dogs, but oils are concentrated fats that can cause digestive upset or other problems."]
---
...
- ❌ **Seasoned sesame oil** — may include garlic, onion, or salt  
- ❌ **Sesame oil used in sauces** — often combined with soy sauce or spices  
- ⚠️ **Mixed cooking oils** — may increase overall fat intake  
