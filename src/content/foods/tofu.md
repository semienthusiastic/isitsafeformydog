---
name: "Tofu"
category: ["Legumes", "Dairy Alternatives"]
status: Caution
image: "/images/tofu.jpg"
description: "Tofu is not classified as toxic to dogs, but veterinary sources note concerns related to soy sensitivity, digestive upset, and added ingredients in prepared tofu products."
...
keywords: ["tofu", "can dogs eat tofu", "tofu dog safety", "soy dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary sources such as the AKC and PetMD state that tofu itself is not toxic to dogs, but soy-based foods may cause digestive upset in some dogs. VCA Hospitals also notes that individual tolerance to soy can vary."]
---
