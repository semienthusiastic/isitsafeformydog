---
name: "Tuna"
category: ["Seafood", "Pantry"]
status: Caution
image: "/images/tuna.jpg"
description: "Tuna is not classified as toxic to dogs, but veterinary sources note concerns related to mercury content, added salt in canned products, and digestive sensitivity."
...
keywords: ["tuna", "can dogs eat tuna", "tuna dog safety", "seafood dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary sources such as the AKC and PetMD state that tuna is not toxic to dogs, but concerns include mercury levels and added salt in canned tuna. VCA Hospitals also notes that fish products may cause digestive issues depending on preparation and frequency."]
---
