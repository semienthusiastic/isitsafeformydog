...
description: "Veterinary and pet-nutrition sources describe pumpkin flesh as safe for dogs when plain and properly prepared, with concerns mainly related to preparation, indigestible parts, and added ingredients."
source: ["AKC", "PetMD", "ASPCA"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-pumpkin/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-pumpkin", "https://www.aspca.org/pet-care/animal-poison-control/toxic-and-non-toxic-plants/pumpkin"]
keywords: ["pumpkin", "can dogs eat pumpkin", "pumpkin dogs", "vegetables dogs"]
shortAnswer: ["Yes, the food is safe for dogs. Veterinary sources such as the AKC and PetMD state that plain pumpkin flesh is safe for dogs, and the ASPCA lists pumpkin as non-toxic, with concerns mainly tied to preparation and added ingredients."]
---
