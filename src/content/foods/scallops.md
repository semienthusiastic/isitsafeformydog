...
keywords: ["scallops", "can dogs eat scallops", "seafood dogs", "shellfish dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary sources such as the AKC and PetMD state that scallops are not poisonous to dogs when plain and cooked, but preparation methods and additives can make them problematic."]
---
...
- ❌ **Salt or seasonings** — add sodium and irritants  
- ❌ **Garlic or onion** — commonly used in seafood dishes and classified as toxic to dogs  
- ⚠️ **Breaded scallops** — include coatings and additives  
