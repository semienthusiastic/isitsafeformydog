...
description: "Veterinary pet-care sources state that dates are not toxic to dogs, but their high sugar content and the presence of pits are associated with digestive upset and choking or obstruction risks."
source: ["AKC", "PetMD"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-dates/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-dates"]
keywords: ["dates", "can dogs eat dates", "dog safety", "dates dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Dates are generally considered non-toxic to dogs according to veterinary sources such as the AKC and PetMD, but they are very high in sugar and contain pits that pose choking or blockage risks. Concerns relate to sugar content and physical hazards rather than toxicity."]
---
...
- ❌ **Date pits** (choking and blockage hazard)  
- ❌ **Added sugars or syrups** (present in some packaged dates)  
- ⚠️ **Dates in baked goods** (often combined with sugar, fat, or chocolate)
