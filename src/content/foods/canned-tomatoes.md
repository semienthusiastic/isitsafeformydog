...
category: ["Pantry"]
status: Caution
image: "/images/canned-tomatoes.jpg"
description: "Veterinary pet-care sources state that ripe tomato flesh is not toxic to dogs, but canned tomatoes often contain added salt or other ingredients, and unripe tomatoes and plant parts are associated with toxicity."
source: ["AKC", "PetMD", "ASPCA"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-tomatoes/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-tomatoes", "https://www.aspca.org/pet-care/animal-poison-control/toxic-and-non-toxic-plants/tomato"]
keywords: ["canned tomatoes", "can dogs eat canned tomatoes", "dog safety", "tomatoes dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Ripe tomato flesh is generally considered non-toxic to dogs according to sources such as the AKC and PetMD, but veterinary references note that canned tomatoes often contain added salt. The ASPCA also highlights that unripe tomatoes and tomato plants contain toxic compounds."]
---
