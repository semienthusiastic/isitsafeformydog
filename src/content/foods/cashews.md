...
description: "Veterinary pet-care sources state that cashews are not toxic to dogs, but they are high in fat and are often salted or seasoned, which may contribute to digestive upset and other health concerns."
source: ["AKC", "PetMD"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-cashews/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-cashews"]
keywords: ["cashews", "can dogs eat cashews", "dog safety", "cashews dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Cashews are generally considered non-toxic to dogs according to sources such as the AKC and PetMD, but veterinary references note that their high fat content and added salt can cause digestive upset. Concerns relate to nutrition and preparation rather than toxicity."]
---
...
- ❌ **Salt** (frequently present in roasted cashews)  
- ❌ **Seasonings or flavour coatings** (may include onion or garlic powders, which are toxic to dogs)  
- ⚠️ **Oils used in roasting** (which may add additional fat)
