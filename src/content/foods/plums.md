...
description: "Veterinary and pet-safety sources describe plums as not toxic to dogs when only the flesh is involved, but note significant risks related to the pit, which contains cyanogenic compounds and poses choking or obstruction hazards."
source: ["AKC", "ASPCA", "PetMD"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-plums/", "https://www.aspca.org/pet-care/animal-poison-control/toxic-and-non-toxic-plants/plum", "https://www.petmd.com/dog/nutrition/can-dogs-eat-plums"]
keywords: ["plums", "can dogs eat plums", "plum dogs", "stone fruit dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary sources such as the AKC, ASPCA, and PetMD explain that plum flesh itself is not toxic to dogs, but the pit contains cyanogenic compounds and presents a serious choking or blockage risk."]
---
...
- ❌ **Plum pits** — contain cyanogenic compounds and pose a physical hazard  
- ❌ **Dried plums (prunes)** — higher sugar concentration  
- ⚠️ **Preserved or flavored plum products** — may include added sugars or additives  
