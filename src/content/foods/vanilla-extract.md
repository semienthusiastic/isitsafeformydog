...
keywords: ["vanilla extract", "can dogs have vanilla extract", "alcohol dogs", "vanilla extract dog safety"]
shortAnswer: ["No, the food is toxic to dogs. Veterinary organisations such as the ASPCA and Pet Poison Helpline list alcohol as toxic to dogs, and vanilla extract contains a high concentration of alcohol. The AKC also notes that vanilla extract is unsafe for dogs due to its alcohol content."]
---
