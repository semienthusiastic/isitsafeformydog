---
name: "Sesame Seeds"
category: ["Nuts", "Seeds", "Pantry"]
status: Caution
image: "/images/sesame-seeds.jpg"
description: "Veterinary and pet-nutrition sources describe sesame seeds as not toxic to dogs, while noting potential digestive upset due to fat content and the way seeds are commonly prepared or used."
source: ["AKC", "PetMD"]
sourceUrl: [
...
keywords: ["sesame seeds", "can dogs eat sesame seeds", "sesame dogs", "seeds dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Veterinary sources such as the AKC and PetMD explain that sesame seeds are not poisonous to dogs, but their fat content and preparation can lead to digestive upset."]
---
...
- ❌ **Seasoned seed mixes** — may include salt, garlic, or onion  
- ❌ **Sesame-coated foods** — often high in salt or sugar  
- ⚠️ **Sesame pastes or spreads** — higher fat concentration  
