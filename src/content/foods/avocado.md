---
name: "Avocado"
metaTitle: "Can Dogs Eat Avocado? What the Sources Actually Say About Persin, the Pit & Fat Risk | Is It Safe For My Dog"
category: ["Fruits"]
status: Caution
image: "/images/avocado.jpg"
description: "The popular 'avocado is toxic to dogs' framing overgeneralises from genuine bird and horse data. The Pet Poison Helpline states 'avocado is non-toxic to dogs and cats' — the only documented danger for dogs is the pit as a mechanical obstruction hazard. The real concerns are the fat load and the pit. This page corrects the record."
source: ["Merck Veterinary Manual — Avocado Toxicosis", "ASPCA — Avocado", "ASPCA — People Foods to Avoid", "American Kennel Club — Can Dogs Eat Avocado?", "Pet Poison Helpline — Avocado"]
sourceUrl: [
  "https://www.merckvetmanual.com/toxicology/food-hazards/avocado-toxicosis-in-animals",
  "https://www.aspca.org/pet-care/aspca-poison-control/toxic-and-non-toxic-plants/avocado",
...
keywords: ["can dogs eat avocado", "avocado toxic dogs", "avocado safe for dogs", "dog ate avocado", "avocado persin dogs", "avocado pit dogs", "avocado skin dogs", "is avocado bad for dogs"]
shortAnswer: ["The popular framing — 'avocado is toxic to dogs' — overstates the evidence for dogs specifically. The Pet Poison Helpline states plainly that 'avocado is non-toxic to dogs and cats,' and identifies the pit as the only documented danger. The ASPCA's people-foods guidance names avocado as 'primarily a problem for birds, rabbits, donkeys, horses and ruminants' — dogs are not among the listed species. Merck states dogs are 'relatively resistant.' The real concerns for dogs are the fat load from the flesh (pancreatitis risk) and the pit as a mechanical obstruction emergency — not acute persin toxicosis. The Toxic framing that dominates online comes from genuine bird and horse data being over-generalised to dogs."]
---
...
[Guacamole](/guacamole/) is the most common processed-avocado food a dog is likely to encounter. The primary concern with guacamole is **not** the avocado — it is the onion (a standard guacamole ingredient) and sometimes garlic, both genuine allium toxins for dogs. The avocado in guacamole contributes fat load and, if a pit was present, an obstruction risk. The guacamole page covers the full two-hazard breakdown including dose calibration for the onion load. For the same allium-in-a-dip concern in a different product, see [hummus](/hummus/).

Other processed avocado products — avocado toast, avocado-based dressings, avocado sushi — are primarily a fat concern. The added-ingredient check (garlic, onion, soy sauce, [salt](/salt/)) is the relevant toxicological question; the avocado component itself follows the flesh picture above.
...
**Dog ate guacamole:** The onion concern may be the more significant hazard. See the [guacamole](/guacamole/) page for calibrated guidance.
