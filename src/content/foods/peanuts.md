...
description: "Veterinary and pet-nutrition sources describe peanuts as not toxic to dogs but note risks related to high fat content, salt, and added ingredients commonly found in processed peanut products."
source: ["AKC", "PetMD"]
sourceUrl: ["https://www.akc.org/expert-advice/nutrition/can-dogs-eat-peanuts/", "https://www.petmd.com/dog/nutrition/can-dogs-eat-peanuts"]
keywords: ["peanuts", "can dogs eat peanuts", "peanut dogs", "nuts dogs"]
shortAnswer: ["Caution: the food is not toxic, but there are risks. Peanuts are not listed as toxic to dogs, but veterinary nutrition sources such as the AKC and PetMD highlight concerns related to high fat content, salt, and added ingredients in many peanut products."]
---
...
- ❌ **Salted peanuts** — elevated sodium levels  
- ❌ **Seasoned or flavored peanuts** — may contain garlic, onion, or spices  
- ⚠️ **Peanut butter with additives** — often contains sugar, salt, or sweeteners  
